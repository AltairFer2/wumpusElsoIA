...
public class MyAgent implements Agent {
	...
	public void direction(int x) {
		...
		if (w.getDirection() == World.DIR_RIGHT) {
			System.out.println("Estoy viendo hacia la derecha");
			i = 1;
		}
		if (w.getDirection() == World.DIR_LEFT) {
			System.out.println("Estoy viendo hacia la izquierda");
			i = 2;
		}
		if (w.getDirection() == World.DIR_UP) {
			System.out.println("Estoy viendo hacia arriba");
			i = 3;
		}
		if (w.getDirection() == World.DIR_DOWN) {
			System.out.println("Estoy viendo hacia la abajo");
			i = 4;
		}
		dif = i - x;
	...
	public void arrow(int x) {
		...
		if (w.getDirection() == World.DIR_DOWN) {
			System.out.println("Estoy viendo hacia abajo");
			i = 4;
		}
		dif = i - x;
		if (dif == 0)
	...
	public void doAction() {
		...
		if (w.hasBreeze(cX, cY)) {
			System.out.println("Estoy en una brisa");
		}
		if (w.hasStench(cX, cY)) {
			System.out.println("Estoy en un hedor");
		}
		if (w.hasPit(cX, cY)) {
			System.out.println("Estoy en un hoyo");
		}
		if (w.getDirection() == World.DIR_RIGHT) {
			System.out.println("Estoy viendo a la derecha");
		}
		if (w.getDirection() == World.DIR_LEFT) {
			System.out.println("Estoy viendo a la izquierda");
		}
		if (w.getDirection() == World.DIR_UP) {
			System.out.println("Estoy viendo a arriba");
		}
		if (w.getDirection() == World.DIR_DOWN) {
			System.out.println("Estoy viendo abajo");
		}
