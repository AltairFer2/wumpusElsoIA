...
public class WumpusWorld {
    ...
    private void runSimulatorDB() {
        ...
        System.out.println("Puntación media: " + totScore);
    }
    ...
    private void runSimulator() {
        ...
        System.out.println("Puntuación media: " + totScore);
    }
    ...
    private int runSimulation(World w) {
        ...
        System.out.println("La simulación terminó después de " + actions + " acciones. Puntaje " + score);
        return score;
    }
}
