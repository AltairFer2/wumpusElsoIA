...
public class GUI implements ActionListener {
    ...
    public GUI() {
        // Crear un nuevo mapa
        WorldMap newMap = new WorldMap(4); // Cambia el tamaño según tus necesidades

        // Agregar el Wumpus a una posición específica
        newMap.addWumpus(1, 3); // Cambia las coordenadas según tus necesidades

        // Agregar el oro a una posición específica
        newMap.addGold(2, 3); // Cambia las coordenadas según tus necesidades

        // Agregar pozos a posiciones específicas (puedes agregar varios pozos)
        newMap.addPit(3, 1); // Cambia las coordenadas según tus necesidades
        newMap.addPit(3, 3); // Cambia las coordenadas según tus necesidades
        newMap.addPit(4, 4); // Cambia las coordenadas según tus necesidades

        // Agregar más elementos al mapa según sea necesario

        // Generar el mundo a partir del mapa
        World wumpusWorld = newMap.generateWorld();
        if (!checkResources()) {
            JOptionPane.showMessageDialog(null, "Unable to start GUI. Missing icons.", "Error",
    ...
    private void createWindow() {
        frame = new JFrame("El mundo de Wumpus");
        ...
        buttons.add(status);
        // Score label
        score = new JLabel("Puntaje: 0", SwingConstants.CENTER);
        ...
        buttons.add(br);
        JButton bg = new JButton("Agarrar");
        bg.setPreferredSize(new Dimension(100, 22));
        bg.setActionCommand("GRAB");
        bg.addActionListener(this);
        buttons.add(bg);
        JButton bc = new JButton("Escalar");
        bc.setPreferredSize(new Dimension(100, 22));
        bc.setActionCommand("CLIMB");
        bc.addActionListener(this);
        buttons.add(bc);
        JButton bs = new JButton("Disparo");
        bs.setPreferredSize(new Dimension(100, 22));
        bs.setActionCommand("SHOOT");
        bs.addActionListener(this);
        buttons.add(bs);
        JButton ba = new JButton("Resolver automáticamente");
        ba.setActionCommand("AGENT");
        ba.addActionListener(this);
        buttons.add(ba);
        // Add a delimiter
        JLabel l = new JLabel("Lista de mundos");
        ...
        buttons.add(mapList);
        JButton bn = new JButton("Nuevo Juego");
    ...
    private void updateGame() {
        ...
        score.setText("Puntaje: " + w.getScore());
        status.setText("");
        if (w.isInPit()) {
            status.setText("¡El jugador debe escalar!");
        }
        if (w.gameOver()) {
            status.setText("Fin del Juego");
        }
